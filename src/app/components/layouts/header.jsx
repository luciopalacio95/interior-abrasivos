    ...
    <header className="bg-slate-200 fixed w-full z-50 top-0 border-solid border-slate-950/30 border-b-2">
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-3 lg:px-8">
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          ...
          <a href="/productos" className="text-xl/6 font-normal text-gray-900 hover:text-gray-500">
            Productos
          </a>
          <a href="/servicios" className="text-xl/6 font-normal text-gray-900 hover:text-gray-500">
            Servicios
          </a>
          <a href="/contacto" className="text-xl/6 font-normal text-gray-900 hover:text-gray-500">
            Contáctenos
          </a>
        </PopoverGroup>
      </nav>
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                ...
                <a href="/empresa" className="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-gray-900 hover:bg-gray-50">
                    Empresa
                </a>
                <a href="/productos" className="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-gray-900 hover:bg-gray-50">
                    Productos
                </a>
                <a href="/servicios" className="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-gray-900 hover:bg-gray-50">
                    Servicios
                </a>
                <a href="/contacto" className="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-gray-900 hover:bg-gray-50">
                    Contáctenos
                </a>
